  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left space-y-8 max-w-2xl animate-fade-in">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-xs font-semibold tracking-wide text-brand-300 uppercase mb-4 shadow-lg">
          ...
          <p className="text-lg text-gray-300 max-w-lg font-light leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-start">
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/40 backdrop-blur-sm text-white rounded-xl font-medium transition-all flex items-center justify-center gap-2"
            >
              Wholesale Inquiry
